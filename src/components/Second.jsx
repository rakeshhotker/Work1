export function Second() {
  return (
    <>
      <div className="w-screen sm:min-h-[500px]  bg-slate-900 flex justify-center items-center lg:min-h-screen">
        <div className="sm:w-[700px] sm:h-[400px] bg-white rounded-xl relative flex lg:h-[600px] lg:w-[1200px]">
          <video
          ...
          <div className="relative z-30 w-full">
            <div>
              <div className="font-bold text-sky-900 xl:text-5xl text-start lg:text-4xl absolute lg:top-32 lg:left-32 md:text-3xl md:top-40 md:left-28 sm:left-24 sm:top-14 sm:text-xl">
                What we do
              </div>
              <div className="xl:w-96 xl:h-16 xl:leading-6 lg:w-80 lg:h-18 lg:top-[500px] absolute lg:left-32 md:top-[400px] md:left-28 md:w-72 md:text-md sm:left-24 sm:w-64 sm:text-sm sm:top-[220px] text-justify lg:text-[15px]">
            ...
            <div>
              <div className=" xl:w-96 xl:h-16 leading-6 lg:w-80 lg:h-18 lg:top-32 absolute lg:left-[700px] xl:left-[750px] md:text-md md:left-[600px] md:top-40 md:w-72 sm:top-14 sm:text-sm sm:w-64 sm:left-[400px] lg:text-[15px]">
              ...
              <div className="font-bold text-sky-900 xl:text-5xl lg:text-4xl lg:top-[500px] absolute lg:left-[700px] xl:left-[750px] md:top-[500px] md:left-[600px] md:text-3xl sm:top-[300px] sm:left-[400px] sm:text-xl">
                Group Values
              </div>
            </div>
          </div>
