    ...
    <>
      <div className="w-screen h-full bg-slate-900 text-white pl-32">
        ...
        <div className="grid grid-row-2 grid-cols-2 pt-20 pl-40 gap-y-10">
          <div className="flex flex-col w-[369px] h-[369px] border rounded-xl justify-around bg-gradient-1 bg-gradient-2 shadow-shadow-custom">
            <div></div>
          ...
          <div className="flex flex-col w-[369px] h-[369px] border rounded-xl justify-around -ml-52">
            <div></div>
            <div className="w-[238px] pl-10 h-[105px] text-xl">
              Rapid scale in audience and geography.
            </div>
          </div>
          <div className="flex flex-col w-[369px] h-[369px] border rounded-xl justify-around">
            <div></div>
            <div className="w-[238px] pl-10 h-[105px] text-xl">
